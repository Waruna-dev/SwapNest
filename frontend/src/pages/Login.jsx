  ...
  return (
    <div className="bg-background font-body text-on-surface antialiased min-h-screen flex flex-col selection:bg-secondary-fixed selection:text-on-secondary-fixed">
        ...
        <section className="hidden md:flex md:w-1/2 lg:w-[55%] relative overflow-hidden bg-primary-container">
          ...
          <div className="relative z-10 p-12 lg:p-16 flex flex-col justify-end w-full h-full pb-20">
            <div className="max-w-xl">
              <span className="font-label text-tertiary-fixed text-[11px] uppercase tracking-[0.3em] mb-6 block">
                Legacy & Circulation
              </span>
              ...
              <p className="text-stone-50/80 text-lg max-w-md font-medium leading-relaxed">
                Curating a world where every object tells a story and every swap
          ...
          <div className="w-full max-w-md space-y-10">
            <div className="text-center md:text-left space-y-3">
              ...
              <p className="text-on-surface-variant font-medium">
                Continue your journey in curated exchange.
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                <label className="font-label text-xs font-bold uppercase tracking-widest text-primary/70 ml-1">
                  Email Address
                </label>
                <input
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  <label className="font-label text-xs font-bold uppercase tracking-widest text-primary/70">
                    Password
                  </label>
                  <a
                    className="text-[11px] font-bold text-secondary uppercase tracking-wider hover:underline transition-all"
                    href="#"
                  >
                    Forgot?
                  </a>
            ...
            <div className="relative py-6">
              ...
              <div className="relative flex justify-center text-xs uppercase tracking-[0.2em] font-bold">
                <span className="bg-surface-container-low px-4 text-on-surface-variant/50">
                  Or authenticate via
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-3 h-14 bg-surface-container-lowest border border-outline-variant/20 rounded-2xl hover:bg-surface-container transition-colors group shadow-sm"
              >
                <svg
              ...
              >
                ...
                >
                  <path
                    ...
                    d="M17.05 20.28c-.96 0-2.04-.6-3.22-.6-1.2 0-2.4.61-3.22.61-1.24 0-2.52-.73-3.32-1.92-1.61-2.41-1.61-6.32 0-8.73.81-1.2 2.08-1.92 3.32-1.92.96 0 2.04.6 3.22.6s2.26-.6 3.22-.6c1.24 0 2.52.73 3.32 1.92a9.14 9.14 0 0 1 1.02 2.05c-.03.02-1.84.72-1.84 2.86 0 2.14 1.81 2.84 1.84 2.86-.25.7-.63 1.34-1.02 2.05-.8 1.19-1.88 1.92-3.12 1.92zM13.83 5.32c0-1.22 1.02-2.22 2.22-2.22 0 0 .02.01.02.01a2.23 2.23 0 0 1-2.24 2.21zm4.24-2.81c0-1.12-.9-2.02-2.02-2.02s-2.02.9-2.02 2.02 2.02 2.02 2.02 2.02 2.02-.9 2.02-2.02z"
                    fill="currentColor"
                  ></path>
                </svg>
                <span className="font-headline font-bold text-sm text-primary">
      ...
      <div className="fixed top-20 right-4 z-40 md:hidden">
        <Link
          to="/"
          className="flex items-center gap-2 bg-white/90 backdrop-blur-xl px-4 py-2 rounded-full border border-gray-200 shadow-md"
        >
          ...
          <span className="font-headline font-black text-sm tracking-tighter text-primary">
            SwapNest
          </span>
        </Link>
      </div>
