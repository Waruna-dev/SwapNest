            ...
            <div className="relative" ref={profileMenuRef}>
              ...
              {isProfileMenuOpen && (
                <div className="absolute right-0 mt-3 w-48 bg-white rounded-2xl shadow-xl border border-outline-variant/20 py-2 animate-fade-in z-50">
                  <Link to="/profile" className="flex items-center gap-2 px-4 py-3 text-sm font-headline font-bold text-primary hover:bg-surface-container-high transition-colors">
