    ...
    <div className="bg-background font-body text-on-surface antialiased min-h-screen flex flex-col selection:bg-secondary-fixed selection:text-on-secondary-fixed">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl shadow-sm border-b border-outline-variant/10">
        <div className="flex justify-between items-center px-6 md:px-8 py-4 max-w-7xl mx-auto">
          <Link
            to="/"
            className="text-2xl font-extrabold text-primary tracking-tighter font-headline hover:opacity-80 transition-opacity"
          >
            SwapNest
          </Link>
          ...
          <div className="flex items-center space-x-4">
            <Link
              to="/login"
              className="hidden md:block bg-secondary text-on-secondary px-6 py-2.5 rounded-full font-headline font-bold text-sm hover:scale-105 transition-transform duration-200 shadow-md"
            >
              Log In
            </Link>
            <Link
              to="/"
              className="text-primary cursor-pointer hover:scale-95 duration-200 flex items-center justify-center"
            >
        ...
        <section className="relative w-full md:w-5/12 lg:w-1/2 min-h-[400px] md:min-h-screen overflow-hidden bg-primary-container">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-8 md:p-16 lg:p-24 pb-20">
            <div className="flex items-center gap-2 mt-8 md:mt-0">
              <span className="text-stone-50 font-headline font-black text-3xl tracking-tighter">
                SwapNest
              </span>
            </div>

            <div className="max-w-md">
              <span className="inline-block px-4 py-1.5 rounded-full bg-tertiary-container text-tertiary-fixed text-[10px] uppercase tracking-widest font-bold mb-6 border border-tertiary-fixed/20">
                Join the Movement
              </span>
              <h1 className="font-headline font-bold text-5xl lg:text-7xl text-stone-50 leading-[1.05] tracking-tight mb-8">
                The art of <br />
                <span className="italic text-secondary-fixed-dim font-medium">
                  circular
                </span>{" "}
                living.
              </h1>
              <p className="text-stone-50/80 text-lg leading-relaxed font-light">
                Exchange premium goods, reduce your footprint, and join a
                community that values craftsmanship over consumption.
              </p>
            </div>
            ...
            <div className="flex items-center gap-6 mt-12 md:mt-0">
              <div className="flex -space-x-4">
                <img
                  ...
                  alt="User"
                  src="https://images.unsplash.com/photo-1531891437562-4301cf35b7e4?auto=format&fit=crop&w=100&q=80"
                />
                <img
                  className="w-12 h-12 rounded-full border-2 border-primary object-cover"
                  alt="User"
                ...
                />
                <div className="w-12 h-12 rounded-full border-2 border-primary bg-secondary flex items-center justify-center text-[10px] font-bold text-white tracking-tighter">
                  +12k
                </div>
              </div>
              <p className="text-stone-50/60 text-sm font-medium tracking-wide">
                Swapping today in <br />
                Colombo, Kandy, & Galle.
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="pt-4">
                <div className="flex justify-between items-center mb-4 ml-1">
                  <label className="block text-[11px] uppercase tracking-widest font-bold text-on-surface-variant">
              ...
              <div className="pt-6">
                ...
                <p className="text-center text-[11px] text-on-surface-variant/60 mt-6 px-8 leading-relaxed font-medium">
                  By creating an account, you agree to SwapNest's{" "}
                  <a
              ...
              <div className="relative py-2">
                ...
                <span className="relative bg-surface-container-low px-4 text-[10px] uppercase tracking-widest text-on-surface-variant font-bold flex justify-center w-fit mx-auto">
                  Or authenticate via
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  type="button"
                  className="flex items-center justify-center gap-3 py-3 px-6 rounded-xl bg-surface-container-lowest border border-outline-variant/20 text-on-surface font-semibold text-sm hover:bg-white transition-all duration-300 shadow-sm group"
                >
                  <svg
