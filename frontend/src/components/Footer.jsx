      ...
      <div className="flex flex-col md:flex-row justify-between items-start w-full px-8 md:px-16 py-20 max-w-7xl mx-auto gap-12">
        ...
        <div className="grid grid-cols-2 gap-12 md:gap-24 w-full md:w-auto">
          ...
          <div className="flex flex-col gap-4">
            ...
            <h4 className="text-on-primary font-headline font-bold tracking-widest text-xs uppercase mb-2">
              Resources
            </h4>
            <a
              className="text-on-primary-container hover:text-on-primary transition-colors font-medium"
              href="#how-it-works"
            >
              How it Works
            </a>
