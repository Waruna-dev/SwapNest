    ...
    <>
      <div className="min-h-screen bg-gray-50 rounded">
        ...
        <div className="max-w-[1400px] mx-auto px-4 py-6">
          ...
          <div className="mb-6 bg-white rounded border border-gray-200 shadow-sm overflow-hidden">
            <div className="p-4">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border transition-all ${
                    showFilters || hasActiveFilters
                      ? "bg-on-tertiary-fixed-variant/90 text-white border-green-600 "
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {isRequester && isPending && (
                                <>
                                  ...
                                  <button
                                    onClick={() => handleCancelClick(swap._id)}
